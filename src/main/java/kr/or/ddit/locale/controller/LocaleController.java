...
public class LocaleController {
	...
	/*
	 * @RequestMapping("/view") public String view(@RequestParam(name = "lang",
	 * defaultValue = "ko")String lang, Model model) {
	 * model.addAttribute("lang",lang); return "tiles.locale"; }
	 */
	 ...
	 * 변경이력 : 위에 메서드와 같다.
	 * @return
	 * Method 설명 : locale test를 위한 view 요청(Locale 인자값을 통한 값선택)
	 */
	@RequestMapping("/view")
